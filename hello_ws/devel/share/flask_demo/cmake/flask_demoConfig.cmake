...
if(NOT "/home/patrick/hello_ws/devel/include " STREQUAL " ")
  set(flask_demo_INCLUDE_DIRS "")
  set(_include_dirs "/home/patrick/hello_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'flask_demo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/patrick/hello_ws/src/flask_demo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/patrick/hello_ws/devel/lib;/home/patrick/hello_ws/devel/lib;/opt/ros/kinetic/lib)
